...
public class SystemDefine {
	...
	public static final String DBHUB_MAJOR_VERSION = "1.8.1";
	public static final String DBHUB_SUB_VERSION = "Build (R0)";
	public static final String DBHUB_RELEASE_DATE = "2018.02.23";
	
	// History Hub
	public static final String HISTORYHUB_NAME = "Tadpole History Hub";
	public static final String HISTORYHUB_MAJOR_VERSION = "1.0.1";
	public static final String HISTORYHUB_SUB_VERSION = "Build (B2)";
	public static final String HISTORYHUB_RELEASE_DATE = "2018.02.23";
